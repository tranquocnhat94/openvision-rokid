...
class SkillDefinition:
    ...
    media_requirements: JsonObject = field(default_factory=dict)
    display_capabilities: list[str] = field(default_factory=list)
    memory_allowed: bool = False
    cloud_behavior: str = "local_only"
...
class RealtimeToolCall:
    ...
    session_id: str | None = None
    source: str = "openai_realtime"
    schema_version: str = "openvision.realtime_tool_call.v1"
...
class ToolResult:
    ...
    result: JsonObject | None = None
    session_id: str | None = None
    display_command: JsonObject | None = None
    duration_ms: int = 0
    schema_version: str = "openvision.tool_result.v1"
    created_at: str = field(default_factory=utc_now)
...
class ToolError:
    ...
    status: str = "error"
    duration_ms: int = 0
    schema_version: str = "openvision.tool_error.v1"
    created_at: str = field(default_factory=utc_now)
...
class MediaCommand:
    ...
    schema_version: str = "openvision.media_command.v1"
    created_at: str = field(default_factory=utc_now)
...
class MediaEvent:
    ...
    status: str
    payload: JsonObject = field(default_factory=dict)
    schema_version: str = "openvision.media_event.v1"
    created_at: str = field(default_factory=utc_now)
...
class DisplayCommand:
    ...
    priority: str = "normal"
    ttl_ms: int = 2500
    schema_version: str = "openvision.display_command.v1"
    created_at: str = field(default_factory=utc_now)
