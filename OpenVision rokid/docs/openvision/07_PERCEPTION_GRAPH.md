...
For YOLO26 live streams, raw detector boxes must be stabilized before becoming
the product graph layer. Apply confidence gates, class filtering, NMS, min-hit
promotion, short track hold, and bbox smoothing before preview/HUD/skills read
the boxes. Raw DeepStream OSD is diagnostic evidence, not graph authority.
