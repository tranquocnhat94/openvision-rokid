...
Cloud AI should be used as a powerful reasoning and agent layer, not as a default video processor.
...
multi-step planning
tool calling
developer/code debugging workflows
```
...
Jetson should send compact context:
